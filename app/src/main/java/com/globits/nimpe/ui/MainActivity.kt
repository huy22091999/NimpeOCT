...
import com.globits.nimpe.ui.home.request_location.ForegroundOnlyLocationService
import com.globits.nimpe.ui.home.request_location.NimpeBroadCastReceiver
...
class MainActivity : NimpeBaseActivity<ActivityMainBinding>(), HomeViewmodel.Factory {
    val REQUEST_FOREGROUND_ONLY_PERMISSIONS_REQUEST_CODE = 356
    ...
    lateinit var broadCastReceiver: NimpeBroadCastReceiver
