...
package com.globits.nimpe.core
...
import com.globits.nimpe.di.HasScreenInjector
...
abstract class NimpeBaseFragment<VB: ViewBinding> : BaseMvRxFragment(), HasScreenInjector {

    protected val nimpeBaseActivity: NimpeBaseActivity<*> by lazy {
        activity as NimpeBaseActivity<*>
    }
    ...
    private lateinit var screenComponent: NimpeComponent
...
//    protected lateinit var unrecognizedCertificateDialog: UnrecognizedCertificateDialog
    ...
    override fun onAttach(context: Context) {
        screenComponent = DaggerNimpeComponent.factory().create(context)
...
//    }
    ...
    override fun injector(): NimpeComponent{
